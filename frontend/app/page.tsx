    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <section id="home" style={{ ...sectionStyle, paddingTop: '4rem' }}>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <p style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--accent)', letterSpacing: '0.04em' }}>
              Grow with Plantera
            </p>
            ...
            <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>
              Plantera gives you a modern toolkit to launch experiences fast—from storefront data to
              product insights and customer feedback pipelines.
            </p>
          ...
          <div style={{ ...cardStyle, display: 'grid', gap: '1rem' }}>
            ...
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ fontWeight: 800, fontSize: '1.5rem' }}>1,280</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontWeight: 700 }}>Avg. satisfaction</span>
                <span style={{ fontWeight: 800, fontSize: '1.5rem' }}>4.8 / 5</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="stores" style={sectionStyle}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>
            Centralize every storefront with unified analytics, rapid onboarding, and real-time
            health checks. Monitor performance and surface issues before they impact customers.
          </p>
          <div
            style={{
              display: 'grid',
          ...
          >
            {['Unified dashboards', 'Sync pipelines', 'Store uptime'].map((item) => (
      ...
      <section id="products" style={{ ...sectionStyle, background: '#fff', borderRadius: '18px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <h2 style={{ margin: 0, fontSize: '2rem' }}>Products</h2>
          <p style={{ color: 'var(--muted)', lineHeight: 1.6 }}>
            Curate offerings quickly with structured data, smart recommendations, and feedback loops
            that keep your catalog relevant.
          </p>
          <div
            style={{
              display: 'grid',
          ...
          >
            {['Catalog curation', 'Insights', 'Launch playbooks'].map((item) => (
      ...
      <section id="contact" style={sectionStyle}>
        <div style={{ ...cardStyle, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <p style={{ color: 'var(--muted)', margin: 0 }}>
            Ready to see Plantera in action? Reach out and our team will tailor a demo for your
            stores and products.
          </p>
